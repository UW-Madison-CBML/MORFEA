...
```python export_video_latents.py --name NEW_MODEL```
then run 
```python export_kanakasabapthy_latents.py --name NEW_MODEL``` 
```python export_cebra.py --name NEW_MODEL``` 
...
```python train_stage_classifier.py --model-name NEW_MODEL [--ARGS]```   
```python train_lstm_classifier.py --kanakasabapathy --model-name NEW_MODEL [--ARGS]```
or 
```python train_lstm_classifier.py --model-name NEW_MODEL [--ARGS]```
