#!/bin/bash
# extract_latents.sh (Fixed version - faster package installation)
...
# Check and install missing packages (optimized - install all at once)
...
try:
    ...
    missing.append("pillow")  # Use lowercase for pip
